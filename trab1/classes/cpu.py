...
class CPU:
    ...
    # Retorna o argumento atual
    def argumento(self):
        return self.__argumento

    # Coloca o estado da cpu como "dormir"
    def dormir(self):
        self.__estado = "dormindo"

    # Retorna o estado interno da CPU
    def salva_estado(self, e):
        e.__pc = self.__pc
        e.__acum = self.__acum
        e.__estado = self.__estado

    # Altera o estado interno da CPU
    def altera_estado(self, e):
        self.__pc , self.__acum, self.__estado = e.estado()
